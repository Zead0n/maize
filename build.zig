...
pub fn build(b: *std.Build) void {
    ...
    // const stage1_elf_install = b.addInstallFileWithDir(bios_stages.stage_one.getEmittedBin(), bios_install_dir, "stage1.elf");
    // const stage2_elf_install = b.addInstallFileWithDir(bios_stages.stage_two.getEmittedBin(), bios_install_dir, "stage2.elf");
